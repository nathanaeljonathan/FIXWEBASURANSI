            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center><h4 class="card-title">DATA DETAIL KEPEMILIKAN ASURANSI</h4></center>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        %>
                                            <tr>
                                                ...
                                                <td><%= a.getSaldo()%></td>
                                                <td>
                                                    <a href="bayarIdPegawai?id=<%= a.getIdDetail()%>"><i class="fa fa-money"></i></a> 
                                                    <a href="klaimIdPegawai?id=<%= a.getIdDetail()%>"><i class="fa fa-thumbs-up"></i></a> 
                                                </td>
                                            </tr>
                                        <%
                                            }
