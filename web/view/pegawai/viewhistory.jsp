                            ...
                            <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <center><h4 class="card-title">HISTORY PEMBAYARAN POLIS: <%= nasabah.getNoPolis() %></h4></center>
                                                <div class="table-responsive m-t-40">
                                                    <table id="myTable" class="table table-bordered table-striped">
                                                        ...
                                                        <%
                                                            ...
                                                            List<Object> datas3 = new PembayaranDao().searchhistory(p, nasabah.getNoPolis().toString());
                                                            if (!datas3.isEmpty()) {
