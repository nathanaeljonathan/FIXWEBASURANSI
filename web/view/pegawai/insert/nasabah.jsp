            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">INSERT NASABAH</h4>
                                <form class="form p-t-20" action="${pageContext.request.contextPath}/nasPegawai" method="POST">
                                <% String nasabah = (String) session.getAttribute("autoID"); %>
                                <div class="form-group">
                                        <label for="exampleInputPolis">No Polis</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" readonly id="exampleInputPolis" name="noPolis" required="" value="<%= nasabah  %>">
                                        </div>
                                    </div>    
                                <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputKtp" name="KTP" value="" requiredn maxlength="16" minlength="16"> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputNama" name="nama" required="" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="exampleInputTgl">Tanggal Lahir</label>
                                        <div class="input-group">
                                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="tgllahir" value="" required>
                                        </div>
                                    </div>
                                    </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="nasabahPegawai" class="btn btn-inverse">Cancel</a>
