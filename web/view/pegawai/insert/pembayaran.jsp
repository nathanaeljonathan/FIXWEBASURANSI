                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form p-t-20" action="${pageContext.request.contextPath}/bayarPegawai" method="POST">
                                <% String asr = (String) session.getAttribute("autoID");%>
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputPolis" name="noPolis" value="<%= nasabah.getNoPolis().getNoPolis() %>" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="exampleInputTgl">Tanggal Bayar</label>
                                        <div class="input-group">
                                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="tglbayar" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputPolis" name="jmlbayar" value="<%= nasabah.getIdAsuransi().getHarga() %>" required readonly="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-actions">
                                            ...
                                            <a href="bayarPegawai" class="btn btn-inverse">Cancel</a>
