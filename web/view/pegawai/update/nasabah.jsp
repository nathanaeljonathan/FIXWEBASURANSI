                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form p-t-20" action="${pageContext.request.contextPath}/prosesUpdateNasabah" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputKtp" name="ktp" value="<%= nasabah.getKtp()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" readonly id="exampleInputPolis" name="noPolis" required="" value="<%= nasabah.getNoPolis()%>" readonly="true">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputNama" name="nama" required="" value="<%= nasabah.getNmNasabah()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="exampleInputTgl">Tanggal Lahir</label>
                                        <div class="input-group">
                                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="tgllahir" value="<%= cc %>">
                                        </div>
                                    </div>
                                    </div>
                                        <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="radio" id="exampleInputStatus" name="status" value="MENIKAH">Menikah <br> <% } else { %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" value="<%= nasabah.getPekerjaan()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="penghasilan" name="penghasilan" value="<%= nasabah.getPenghasilan()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="alamat" name="alamat" value="<%= nasabah.getAlamat()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="input-group-addon">
                                                <select class="form-control" id="val-skill" name="admin">
                                                    ...
                                                    for (Object data : datas2) {
                                                        ...
                                                        if (nasabah.getIdAdmin().getIdAdmin().equals(admin.getIdAdmin())) {
                                                %>
