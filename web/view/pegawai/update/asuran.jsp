...
<body class="fix-header fix-sidebar">
    <%   
        Object datas = session.getAttribute("asuransi");
        Asuransi asuransi = (Asuransi) datas;
        %>
        <!-
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">UPDATE ASURANSI</h4>
                                <form class="form p-t-20" action="${pageContext.request.contextPath}/prosesUpdateAsuran" method="POST">
                                    <div class="form-group">
                                        <label for="exampleInputId">ID</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputId" name="txtID" value="<%= asuransi.getIdAsuransi()%>" readonly="true">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputNama">Nama Asuransi</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputNama" name="txtNama" value="<%= asuransi.getNmAsuransi()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputNama">Bunga</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputNama" name="bunga" value="<%= asuransi.getBunga()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputNama">Masa Berlaku</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputNama" name="masa" value="<%= asuransi.getMasaBerlaku()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputNama" name="harga" value="<%= asuransi.getHarga()%>">
                                        </div>
                                    </div>
