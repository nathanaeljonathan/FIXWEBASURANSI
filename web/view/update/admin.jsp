<%-- 
    Document   : admin
    Created on : Apr 17, 2018, 1:13:34 PM
    Author     : Medina
--%>
                        ...
                        <div class="contact_content">
                            <div class="col-md-6">
                                <div class="single_left_contact">
                                    <form id="formid" action="prosesUpdateAdmin" method="POST">

                                        <div class="form-group">
                                            <input type="text" class="form-control" name="idAdmin" placeholder="idAdmin" value="<%= admin.getIdAdmin()%>" readonly="true">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="nmAdmin" placeholder="Nama" value="<%= admin.getNamaAdmin()%>">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="alamat" placeholder="Alamat" value="<%= admin.getAlamat()%>">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="noTelp" placeholder="noTelp" value="<%= admin.getNoTelp()%>">
                                        </div>
