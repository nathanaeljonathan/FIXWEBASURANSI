<%-- 
    Document   : asuransi
    Created on : Apr 17, 2018, 6:52:38 PM
    Author     : Medina
--%>
                ...
                <div class="row">
                    <div class="main_contact whitebackground">
                        <div class="head_title text-center">
                            <h2>UPDATE ASURANSI</h2>
                        </div>
                        <div class="contact_content">
                            <div class="col-md-6">
                                <div class="single_left_contact">
                                    <form id="formid" action="prosesUpdateAsuran" method="POST">

                                        <div class="form-group">
                                            <input type="text" name="txtID" value="<%= asuransi.getIdAsuransi()%>" readonly="true">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" name="txtNama" value="<%= asuransi.getNmAsuransi()%>">
                                        </div>
