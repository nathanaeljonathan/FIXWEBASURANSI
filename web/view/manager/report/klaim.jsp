            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Report Data Klaim</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <%
                                            List<Object> datas = (List<Object>) session.getAttribute("dataReportKlaimManager") ;
                                            int i = 1;
                                            for (Object data : datas) {
                                                Klaim a = (Klaim) data;
                                                DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
                                                String cc = dateFormat.format(a.getTglKlaim());
                                        %>
                                            <tr>
                                                <td><%= a.getIdKlaim()%></td>
                                                <td><%= a.getNoPolis()%></td>
