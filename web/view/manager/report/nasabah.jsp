            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Report Data Nasabah</h4>
                                <h6 class="card-subtitle">Export data to PDF & Print</h6>
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <%
                                            List<Object> datas = (List<Object>) session.getAttribute("dataReportNasabahManager") ;
                                            int i = 1;
