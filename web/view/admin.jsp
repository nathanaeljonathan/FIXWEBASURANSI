<%-- 
    Document   : admin
    Created on : Apr 16, 2018, 8:40:19 PM
    Author     : Medina
--%>
...
<html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <section id="business" class="portfolio sections">
            ...
            <tbody>
                <tr>
                    ...
                    <td><%= a.getEmail() %></td>
                    <td>
                        <a href="adminUpdateServlet?id=<%= a.getIdAdmin()%>" class="button">Update</a>
                    <a href="adminDeleteServlet?id=<%= a.getIdAdmin()%>" class="button">Delete</a>
                    </td>
                </tr>
            </tbody>
            <%
        ...
        <br>
        <a href="adminAutoID" class="button button1">ADD</a>
