                                ...
                                <% String klaim = (String) session.getAttribute("autoID"); %>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputId" name="idklaim" value="<%= klaim  %>" disabled="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="tglklaim" value="">
                                        </div>
                                    </div>
