                                ...
                                <% String admin = (String) session.getAttribute("autoID"); %>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="nobayar" id="exampleInputId" value="<%= admin %>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputNama" name="noPolis" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                                ...
                                                <select class="form-control" id="val-skill" name="admin">
                                                    <% List<Object> datas2 = new AsuransiDao().getAll();
                                                        for (Object data : datas2){
                                                            Asuransi as = (Asuransi) data; %>
                                                            <option value="<%= as.getIdAsuransi()%>"><%= as.getNmAsuransi()%></option>
                                                        <%
                                                        }
                                                        %>
                                                </select>
                                        ...
                                        <div class="form-group">
                                        <label for="exampleInputTelp">Saldo</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputTelp" name="saldo" value="">
                                        </div>
                                    </div>
