<%-- 
    Document   : admin
    Created on : Apr 17, 2018, 11:18:27 PM
    Author     : Medina
--%>
                        ...
                        <div class="contact_content">
                            <div class="col-md-6">
                                <div class="single_left_contact">
                                    <form id="formid" action="adminInsertServlet" method="POST">
                                        <% String admin = (String) session.getAttribute("autoID"); %>

                                        <div class="form-group">
                                            <input type="text" class="form-control" name="idAdmin" placeholder="idAdmin" value="<%= admin %>" disabled="">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="nmAdmin" placeholder="Nama" value="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control" name="noTelp" placeholder="noTelp" value="">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="mail" class="form-control" name="email" placeholder="Email" value="">
                                        </div>
