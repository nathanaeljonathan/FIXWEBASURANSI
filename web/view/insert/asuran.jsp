<%-- 
    Document   : asuran
    Created on : Apr 17, 2018, 8:06:45 PM
    Author     : Medina
--%>
                ...
                <div class="row">
                    <div class="main_contact whitebackground">
                        <div class="head_title text-center">
                            <h2>INSERT ANSURANSI</h2>
                        </div>
                        <div class="contact_content">
                            <div class="col-md-6">
                                <div class="single_left_contact">
                                    <form id="formid" action="asuranInsertServlet" method="POST">
                                        <% String asuransi = (String) session.getAttribute("autoId"); %>

                                        <div class="form-group">
                                            <input type="text" class="form-control" name="txtID" placeholder="ID" value="<%= asuransi %>" disabled="">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="txtNama" placeholder="Nama" value="">
                                        </div>
