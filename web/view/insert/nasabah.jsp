                ...
                <div class="row">
                    <div class="main_contact whitebackground">
                        <div class="head_title text-center">
                            <h2>INSERT NASABAH</h2>
                        </div>
                        <div class="contact_content">
                            <div class="col-md-6">
                                <div class="single_left_contact">
                                    <form id="formid" action="nasabahInsertServlet" method="POST">
                                        <% String nasabah = (String) session.getAttribute("autoID"); %>

                                        <div class="form-group">
                                            <input type="text" class="form-control" name="KTP" placeholder="KTP"  value="">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="noPolis" placeholder="No Polis" required="" value="<%= nasabah  %>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="date" class="form-control" name="tgllahir" placeholder="Tanggal Lahir" value="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="pekerjaan" placeholder="Pekerjaan" required="" value="">
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="penghasilan" placeholder="Penghasilan" required="" value="">
                                        </div>
