            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">INSERT ASURANSI</h4>
                                <form class="form p-t-20" action="${pageContext.request.contextPath}/asuranInsertServlet" method="POST">
                                <% String asuransi = (String) session.getAttribute("autoId"); %>
                                    <div class="form-group">
                                        <label for="exampleInputId">ID</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputId" name="txtID" value="<%= asuransi %>" readonly="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputNama" name="txtNama" value="" required>
                                        </div>
                                    </div>
