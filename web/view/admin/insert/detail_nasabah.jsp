                                ...
                                <% Long noPol = new Long(session.getAttribute("id").toString()); %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="nobayar" id="exampleInputId" value="<%= detail_nas %>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputTelp" name="saldo" value="0" readonly="">
                                        </div>
                                    </div>
                                    
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success"> <i class="fa fa-check"></i> Save</button>
                                        <a href="detailNasServlet" class="btn btn-inverse">Cancel</a>
