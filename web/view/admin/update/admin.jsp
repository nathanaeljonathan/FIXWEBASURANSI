                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form p-t-20" action="${pageContext.request.contextPath}/prosesUpdateAdmin" method="POST">
                                    <div class="form-group">
                                        <label for="exampleInputId">ID Pegawai</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" name="idAdmin" id="exampleInputId" value="<%= admin.getIdAdmin()%>" readonly="true">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputNama" name="nmAdmin" value="<%= admin.getNamaAdmin()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="alamat" name="alamat" value="<%= admin.getAlamat()%>">
                                        </div>
                                    </div>
                                        <div class="form-group">
                                        <label for="exampleInputTelp">Nomor Telp</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"></div>
                                            <input type="text" class="form-control" id="exampleInputTelp" name="noTelp" value="<%= admin.getNoTelp()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></i></div>
                                            <input type="password" class="form-control" id="password" name="password" value="<%= admin.getPassword()%>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"></i></div>
                                             <select class="form-control" id="val-skill" name="hakakses" value="<%= admin.getEmail()%>">
                                                    <option>ADMIN</option>
