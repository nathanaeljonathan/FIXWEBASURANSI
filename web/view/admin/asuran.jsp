            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center><h4 class="card-title">DATA ASURANSI</h4></center>
                            ...
                            //                        a.getMasaBerlaku(); }
                                                ...
                                                <td><%= a.getHarga() %></td>
                                                <td>
                                                    <a href="asuranUpdateServlet?id=<%= a.getIdAsuransi()%>"><i class="fa fa-edit"></i></a>
                                                    <a href="${pageContext.request.contextPath}/asuranDeleteServlet?id=<%= a.getIdAsuransi()%>"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <%
                                            }
