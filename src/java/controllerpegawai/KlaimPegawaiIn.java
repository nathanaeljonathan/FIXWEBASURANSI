 ...
 * @author Medina
 */
public class KlaimPegawaiIn extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (kmdao.insert(klaim)) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("klaimPegawai");
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("view/pegawai/insert/klaim.jsp");
                dispatcher.include(request, response); 
            }
        }
    }
