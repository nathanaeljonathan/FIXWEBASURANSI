 ...
 * @author Medina
 */
public class DetnasPegawai extends HttpServlet {
...
//        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (pdao.insert(bayar)) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("detailNasPegawai");
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("view/pegawai/insert/detail_nasabah.jsp");
                dispatcher.include(request, response); 
            }
        }
    }
