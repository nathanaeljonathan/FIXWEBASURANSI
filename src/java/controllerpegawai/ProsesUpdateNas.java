 ...
 * @author Medina
 */
public class ProsesUpdateNas extends HttpServlet {
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           if (ndao.update(nasabah)) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("nasabahPegawai");
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("view/pegawai/update/admin.jsp");
                dispatcher.include(request, response); 
            } 
        }
    }
